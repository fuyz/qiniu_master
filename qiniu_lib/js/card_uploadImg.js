 ...
 */
    //获取uptoken
var uptoken = '', n = 1, imgArr = [];
(function getUptoken() {
    $.ajax({
        method: "get",
        url: 'http://10.0.0.81:8000/qiniu_test/token',
        dataType: 'json',
        headers: {
...
//            uptoken_url: $('#uptoken_url').val(),
            ...
            init: {
                ...
                'FileUploaded': function (up, file, info) {
                    ...
                    imgArr.push('<a class="item" href="#"><img src="'+ sourceLink +'"></a>');
                    $('.carouseldiv').html(' <div id="myCarousel" class="owl-carousel"></div>');
                    for(var i = 0; i < imgArr.length; i++){
                        $('#myCarousel').append(imgArr[i]);
                    }
                    //激活轮播图配置
                    function cc() {
                        $('#myCarousel').owlCarousel({//#myCarousel1
                            items: 1,
                            autoPlay: 3000,
                            singleItem: true
                        });
