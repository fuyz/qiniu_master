...
function QiniuJsSDK() {
    ...
    function log(type, args){
        var header = "[qiniu_test-js-sdk]["+type+"]";
        var msg = header;
        ...
        if (document.getElementById('qiniu_test-js-sdk-log')) {
            document.getElementById('qiniu_test-js-sdk-log').innerHTML += '<p>'+msg+'</p>';
        }
    }
    ...
    if (window.location.protocol === 'https:') {
        ...
        qiniuUploadUrl = 'http://upload.qiniu_test.com';
    }

    /**
     * qiniu_test upload urls
     * 'qiniuUploadUrls' is used to change target when current url is not avaliable
     * @type {Array}
     */
    var qiniuUploadUrls = [
        "http://upload.qiniu_test.com",
        "http://up.qiniu_test.com"
    ];
    ...
    this.uploader = function(op) {
        ...
        var reset_chunk_size = function() {
            ...
            if (ie && ie < 9 && op.chunk_size && op.runtimes.indexOf('flash') >= 0) {
                ...
                // qiniu_test service  max_chunk_size is 4m
